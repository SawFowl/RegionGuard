...
public class SetBlocksLimitCommand implements Command.Raw {
	...
	public Optional<Component> shortDescription(CommandCause cause) {
		return Optional.of(Component.text("Changing the player blocks limit."));
	}
	...
	public Component usage(CommandCause cause) {
		return Component.text("/rg setlimitblocks");
	}
