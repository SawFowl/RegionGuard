...
public class Claim extends AbstractPlayerCommand {
	...
	public Component usage(CommandCause cause) {
		return TextUtils.deserializeLegacy("&6/rg claim&f - ").clickEvent(ClickEvent.runCommand("/rg claim")).append(getComponent(getLocale(cause), LocalesPaths.COMMANDS_CLAIM));
	}
