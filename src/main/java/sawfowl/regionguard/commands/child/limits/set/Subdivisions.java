...
public class Subdivisions extends AbstractCommand {
	...
	public String permission() {
		return Permissions.STAFF_SETLIMIT_SUBDIVISIONS;
	}
	...
	public List<RawArgument<?>> getArgs() {
		return Arrays.asList(
			RawArguments.createPlayerArgument(false, false, 0, null, LocalesPaths.COMMAND_SETLIMITSUBDIVISIONS_EXCEPTION_PLAYER_NOT_PRESENT),
			RawArguments.createLongArgument("Value", new ArrayList<Long>(), false, false, 1, null, null, LocalesPaths.COMMAND_SETLIMITSUBDIVISIONS_EXCEPTION_VOLUME_NOT_PRESENT)
		);
	}
