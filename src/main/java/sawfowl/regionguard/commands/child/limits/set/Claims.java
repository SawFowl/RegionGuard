...
public class Claims extends AbstractCommand {
	...
	public List<RawArgument<?>> getArgs() {
		return Arrays.asList(
			RawArguments.createPlayerArgument(false, false, 0, null, null, null, LocalesPaths.COMMAND_SETLIMITCLAIMS_EXCEPTION_PLAYER_NOT_PRESENT),
			RawArguments.createLongArgument("Value", new ArrayList<Long>(), false, false, 1, null, null, null, null, LocalesPaths.COMMAND_SETLIMITCLAIMS_EXCEPTION_VOLUME_NOT_PRESENT)
		);
	}
