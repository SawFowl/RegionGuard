...
public class Set extends AbstractCommand {
	...
	public Component usage(CommandCause cause) {
		return TextUtils.deserializeLegacy("&6/rg set &7[Limit] [Player] [Volume]&f - ").clickEvent(ClickEvent.runCommand("/rg set ")).append(extendedDescription(getLocale(cause)));
	}
