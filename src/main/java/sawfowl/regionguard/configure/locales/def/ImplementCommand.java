...
import sawfowl.regionguard.configure.locales.def.command.ImplementClaim;
import sawfowl.regionguard.configure.locales.def.command.ImplementClear;
import sawfowl.regionguard.configure.locales.def.command.ImplementDelete;
import sawfowl.regionguard.configure.locales.def.command.ImplementExceptions;
import sawfowl.regionguard.configure.locales.def.command.ImplementFlag;
import sawfowl.regionguard.configure.locales.def.command.ImplementInfo;
import sawfowl.regionguard.configure.locales.def.command.ImplementLeave;
import sawfowl.regionguard.configure.locales.def.command.ImplementLimits;
import sawfowl.regionguard.configure.locales.def.command.ImplementList;
import sawfowl.regionguard.configure.locales.def.command.ImplementMain;
import sawfowl.regionguard.configure.locales.def.command.ImplementSetCreatingType;
import sawfowl.regionguard.configure.locales.def.command.ImplementSetMessage;
import sawfowl.regionguard.configure.locales.def.command.ImplementSetName;
import sawfowl.regionguard.configure.locales.def.command.ImplementSetOwner;
import sawfowl.regionguard.configure.locales.def.command.ImplementSetSelectorType;
import sawfowl.regionguard.configure.locales.def.command.ImplementTrust;
import sawfowl.regionguard.configure.locales.def.command.ImplementUntrust;
import sawfowl.regionguard.configure.locales.def.command.ImplementUpdateDefaultFlags;
import sawfowl.regionguard.configure.locales.def.command.ImplementWand;
import sawfowl.regionguard.configure.locales.def.command.ImplementWeCUI;
