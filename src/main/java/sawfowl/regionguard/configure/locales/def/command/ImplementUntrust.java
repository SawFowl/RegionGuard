...
public class ImplementUntrust implements Untrust {
	...
	@Setting("Success")
	private Component success = deserialize("&aYou have excluded a player from the region &b" + PlaceholderKeys.PLAYER + "&a.");
	@Setting("SuccessTarget")
	private Component successTarget = deserialize("&b" + PlaceholderKeys.PLAYER + " &eexcludes you from the region in the world &b" + PlaceholderKeys.WORLD + " &eas the boundaries from &e" + PlaceholderKeys.MIN + " &ato &e" + PlaceholderKeys.MAX + "&a.");
