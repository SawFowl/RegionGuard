...
public class ImplementSell implements Sell {
	...
	private ImplementLimit subdivisions = new ImplementLimit("&6Selling the limit of subdivisions for game currency.", "&aYou have reduced your subdivisions limit by &b" + Placeholders.SIZE + "&a. Your current subdivisions limit: &b" + Placeholders.VOLUME + "&a.");
	@Setting("Members")
	private ImplementLimit members = new ImplementLimit("&6Selling the limit of region members for game currency.", "&aYou have reduced your region members limit by &b" + Placeholders.SIZE + "&a. Your current members limit: &b" + Placeholders.VOLUME + "&a.");
