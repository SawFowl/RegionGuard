...
public class ImplementEntityInteract implements Interact {
	...
	@Setting("Primary")
	private Component primary = deserialize("&cВы не можете взаимодействовать с сущностью в текущем регионе, нажимая левую кнопку мыши.");
	@Setting("Secondary")
	private Component secondary = deserialize("&cВы не можете взаимодействовать с сущностью в текущем регионе, нажимая правую кнопку мыши.");
